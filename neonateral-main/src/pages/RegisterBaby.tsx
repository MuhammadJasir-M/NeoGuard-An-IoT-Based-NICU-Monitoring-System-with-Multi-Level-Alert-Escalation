      ...
      <DashboardLayout>
        <div className="flex flex-col items-center justify-center min-h-[60vh]">
          ...
          <p className="text-muted-foreground">
            Only doctors can register new babies.
          </p>
        </div>
      </DashboardLayout>
    );
        ...
        <Card className="card-medical mt-4">
          <CardContent className="p-4">
            <p className="text-sm text-muted-foreground">
              <strong>Note:</strong> Once registered, the baby will immediately
              begin monitoring. The behavior baseline system will start tracking
              patterns and will establish a baseline after 3-4 days of
              observation.
            </p>
          </CardContent>
        </Card>
