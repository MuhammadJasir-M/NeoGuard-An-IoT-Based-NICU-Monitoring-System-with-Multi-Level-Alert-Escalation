    ...
    <DashboardLayout>
      <div className="space-y-6 alert-section animate-fade-in">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <Card className="card-medical glow-hover-critical border-status-critical/35 bg-status-critical-bg/35 dark:bg-[rgba(255,0,60,0.14)] dark:border-[rgba(255,64,96,0.45)]">
            <CardContent className="p-4">
          ...
          <Card className="card-medical glow-hover-warning border-status-warning/35 bg-status-warning-bg/35 dark:bg-[rgba(255,170,0,0.14)] dark:border-[rgba(255,170,0,0.45)]">
            <CardContent className="p-4">
          ...
          <Card className="card-medical glow-hover-normal border-status-normal/35 bg-status-normal-bg/35 dark:bg-[rgba(0,255,136,0.12)] dark:border-[rgba(0,255,136,0.42)]">
            <CardContent className="p-4">
        ...
        <Card className="card-medical">
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              {sortedAlerts.filter((a) => a.escalationLevel > 0).length ===
                0 && (
